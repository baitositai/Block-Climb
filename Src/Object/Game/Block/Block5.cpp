...
void Block5::HitUpdate(Vector2 pos)
{
...
void Block5::Reset(void)
{
    setBlockCnt_ = 0;

    //地面用Csvデータ
    groundCsvDate_ = (Application::PATH_CSV + "Stage5.csv").c_str();
    putZoneCsvData_ = (Application::PATH_CSV + "Stage5PutBlockZone.csv").c_str();
...
void Block5::LoadStageCsvData(void)
{
    //ファイルの準備
...
void Block5::LoadPositionCsvData(void)
{
    //ファイルの準備
...
void Block5::BlockSet(int MinoX, int MinoY, int MinoType_)
{
