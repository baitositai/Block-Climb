...
public:
	...
	//半角文字用中心点を求めるよう定数
	static constexpr int HALF_CHAR_DIV = 4;
	...
	//上下に揺らす
	static Vector2 SinShake(Vector2 pos, float value1, float value2);

	//ベクターの計算
	static Vector2 V2Ado(Vector2 pos1, Vector2 pos2);
	static Vector2 V2Sub(Vector2 pos1, Vector2 pos2);
	static Vector2 V2Mul(Vector2 pos1, Vector2 pos2);
	static Vector2 V2Div(Vector2 pos1, Vector2 pos2);
