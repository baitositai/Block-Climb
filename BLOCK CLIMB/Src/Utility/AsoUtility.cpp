...
Vector2 AsoUtility::SinShake(Vector2 pos, float value1, float value2)
{
...
Vector2 AsoUtility::V2Ado(Vector2 pos1, Vector2 pos2)
{
    Vector2 pos;
    pos.x = pos1.x + pos2.x;
    pos.y = pos1.y + pos2.y;
...
Vector2 AsoUtility::V2Sub(Vector2 pos1, Vector2 pos2)
{
    Vector2 pos;
    pos.x = pos1.x - pos2.x;
    pos.y = pos1.y - pos2.y;
...
Vector2 AsoUtility::V2Mul(Vector2 pos1, Vector2 pos2)
{
    Vector2 pos;
    pos.x = pos1.x * pos2.x;
    pos.y = pos1.y * pos2.y;
...
Vector2 AsoUtility::V2Div(Vector2 pos1, Vector2 pos2)
{
    Vector2 pos;
    pos.x = pos1.x / pos2.x;
    pos.y = pos1.y / pos2.y;
